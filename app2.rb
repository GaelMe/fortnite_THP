...
puts "----------------------------------------------------"
puts ""
puts "Veuillez entrer votre speudo de guerrier de l'appocalypse"
print " >> "
...
(human1.life_points > 0)? (puts "Bravo ! Tu as gagné ! ") : (puts "Loser ! sauf si tu es le correcteur ^ dans ce cas tu peux recommencer ^ ^ ")
